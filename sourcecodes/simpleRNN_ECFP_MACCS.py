...
def train_simpleRNN_model(x_train, x_test, y_train, y_test, model_filename='simpleRNN_ecfp_maccs.keras', plot_filename='simpleRNN_ecfp_maccs.png', epochs=50, batch_size=2):
...
def main():
    # Load data from CSV
    x_train = pd.read_csv("irritation_x_train_att_ecfp_maccs.csv",index_col=0)
    x_test = pd.read_csv("irritation_x_test_att_ecfp_maccs.csv",index_col=0)
