...
def train_BiLSTM_model(x_train, x_test, y_train, y_test, model_filename='bilstm_ecfp_rdkit.keras', plot_filename='bilstm_ecfp_rdkit.png', epochs=50, batch_size=2):
