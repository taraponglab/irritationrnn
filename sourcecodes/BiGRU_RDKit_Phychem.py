...
def train_BiGRU_model(x_train, x_test, y_train, y_test, model_filename='BiGRU.keras', plot_filename='training_lost.png', epochs=50, batch_size=2):
...
def main():
    # Load data from CSV
    x_train = pd.read_csv("irritation_x_train_att_rdkit_descriptors.csv",index_col=0)
    x_test = pd.read_csv("irritation_x_test_att_rdkit_descriptors.csv",index_col=0)
