...
def train_lstm_model(x_train, x_test, y_train, y_test, model_filename='lstm_ecfp_descriptors.keras', plot_filename='lstm_ecfp_descriptors.png', epochs=50, batch_size=2):
